...
class ControllerPaymentPPStandard extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validate())) {
			...
			Make::a('setting/setting')->create()->editSetting('pp_standard', $this->request->post);				
		...
		$this->document->breadcrumbs = array();
   		...
   		$this->document->breadcrumbs[] = array(
       		'href'      => HTTPS_SERVER . 'payment/pp_standard&token=' . $this->session->data['token'],
       		'text'      => $this->language->get('heading_title'),
      		'separator' => ' :: '
   		);
				
		$this->data['action'] = HTTPS_SERVER . 'payment/pp_standard&token=' . $this->session->data['token'];
