...
class ControllerModuleLatest extends Controller {
	...
	if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validate())) {
	    Make::a('setting/setting')->create()->editSetting('latest', $this->request->post);
	...
	$this->document->breadcrumbs[] = array(
	    'href' => HTTPS_SERVER . 'module/latest&token=' . $this->session->data['token'],
	    'text' => $this->language->get('heading_title'),
	    'separator' => ' :: '
	);

	$this->data['action'] = HTTPS_SERVER . 'module/latest&token=' . $this->session->data['token'];
