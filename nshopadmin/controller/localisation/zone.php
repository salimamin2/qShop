...
class ControllerLocalisationZone extends Controller {
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->redirect(HTTPS_SERVER . 'localisation/zone&token=' . $this->session->data['token'] . $url);
		}
	...
	private function getList() {
		...
		$this->data['insert'] = makeUrl('localisation/zone/insert');
		$this->data['delete'] = makeUrl('localisation/zone/delete');
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'icon' => 'icon-pencil',
                'class' => 'btn-info',
				'href' => makeUrl('localisation/zone/update',array('zone_id=' . $result['zone_id']))
			);
	...
	private function getForm() {
		...
		if (isset($this->request->get['order'])) {
  		...
  		$this->document->breadcrumbs = array();
   		...
   		$this->document->breadcrumbs[] = array(
       		'href'      => HTTPS_SERVER . 'localisation/zone&token=' . $this->session->data['token'] . $url,
       		'text'      => $this->language->get('heading_title'),
      		'separator' => ' :: '
   		);
							
		if (!isset($this->request->get['zone_id'])) {
			$this->data['action'] = HTTPS_SERVER . 'localisation/zone/insert&token=' . $this->session->data['token'] . $url;
		} else {
			$this->data['action'] = HTTPS_SERVER . 'localisation/zone/update&token=' . $this->session->data['token'] . '&zone_id=' . $this->request->get['zone_id'] . $url;
		}
		 
		$this->data['cancel'] = HTTPS_SERVER . 'localisation/zone&token=' . $this->session->data['token'] . $url;
