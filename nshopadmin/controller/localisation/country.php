...
class ControllerLocalisationCountry extends Controller {
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->redirect(HTTPS_SERVER . 'localisation/country&token=' . $this->session->data['token'] . $url);
		}
	...
	private function getList() {
        ...
        $this->document->breadcrumbs = array();
   		...
   		$this->document->breadcrumbs[] = array(
       		'href'      => makeUrl('localisation/country'),
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'icon' => 'icon-pencil',
                'class' => 'btn-info',
				'href' => makeUrl('localisation/country/update',array('country_id=' . $result['country_id']))
			);
        ...
        $this->data['insert'] = makeUrl('localisation/country/insert');
		$this->data['delete'] = makeUrl('localisation/country/delete');
	...
	private function getForm() {
		...
		if (isset($this->request->get['order'])) {
  		...
  		$this->document->breadcrumbs = array();
   		...
   		$this->document->breadcrumbs[] = array(
       		'href'      => HTTPS_SERVER . 'localisation/country&token=' . $this->session->data['token'] . $url,
       		'text'      => $this->language->get('heading_title'),
      		'separator' => ' :: '
   		);
							
		if (!isset($this->request->get['country_id'])) { 
			$this->data['action'] = HTTPS_SERVER . 'localisation/country/insert&token=' . $this->session->data['token'] . $url;
		} else {
			$this->data['action'] = HTTPS_SERVER . 'localisation/country/update&token=' . $this->session->data['token'] . '&country_id=' . $this->request->get['country_id'] . $url;
		}
		
		$this->data['cancel'] = HTTPS_SERVER . 'localisation/country&token=' . $this->session->data['token'] . $url;
