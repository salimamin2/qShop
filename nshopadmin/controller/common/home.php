...
class ControllerCommonHome extends Controller {
	...
	$this->data['text_lead_customers'] = $this->language->get('text_lead_customers');
	$this->data['text_update_customers'] = $this->language->get('text_update_customers');
	...
	$this->data['column_customer'] = $this->language->get('column_name');
	...
	$this->data['msg_lead_customers'] = $this->language->get('msg_lead_customers');
	$this->data['msg_update_customers'] = $this->language->get('msg_update_customers');
	...
	$this->data['total_product'] = Make::a('catalog/product')->count();
...
//	$this->data['total_review_approval'] = $this->model_catalog_review->getTotalReviewsAwaitingApproval();
	...
	$data['order']['label'] = __('text_order');
	$data['customer']['label'] = __('text_customer');
