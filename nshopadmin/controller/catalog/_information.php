...
class ControllerCatalogInformation extends Controller {
    ...
    private function getList() {
        ...
        $this->data['insert'] = HTTPS_SERVER . 'catalog/information/insert&token=' . $this->session->data['token'] . $url;
        $this->data['delete'] = HTTPS_SERVER . 'catalog/information/delete&token=' . $this->session->data['token'] . $url;
        ...
        $this->data['sort_title'] = HTTPS_SERVER . 'catalog/information&token=' . $this->session->data['token'] . '&sort=id.title' . $url;
        $this->data['sort_sort_order'] = HTTPS_SERVER . 'catalog/information&token=' . $this->session->data['token'] . '&sort=i.sort_order' . $url;
        ...
        $pagination->url = HTTPS_SERVER . 'catalog/information&token=' . $this->session->data['token'] . $url . '&page={page}';
