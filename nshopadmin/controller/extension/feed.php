			...
			foreach ($files as $file) {
				...
				if (!in_array($extension, $extensions)) {
					$action[] = array(
                        ...
                        'class' => 'btn-success', 
						'href' => HTTPS_SERVER . 'extension/feed/install&token=' . $this->session->data['token'] . '&extension=' . $extension
					);
				} else {
					$action[] = array(
						...
						'icon' => 'icon-pencil',
                        'class' => 'btn-info',
						'href' => HTTPS_SERVER . 'feed/' . $extension . '&token=' . $this->session->data['token']
					);
					...
					$action[] = array(
                        ...
                        'class' => 'btn-danger',
						'href' => HTTPS_SERVER . 'extension/feed/uninstall&token=' . $this->session->data['token'] . '&extension=' . $extension
					);
				}
