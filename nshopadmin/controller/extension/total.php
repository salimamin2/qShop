			...
			foreach ($files as $file) {
				...
				if (!in_array($extension, $extensions)) {
					$action[] = array(
                        ...
                        'class' => 'btn-success',
						'href' => HTTPS_SERVER . 'extension/total/install&token=' . $this->session->data['token'] . '&extension=' . $extension
					);
				} else {
					$action[] = array(
						...
						'icon' => 'icon-pencil',
                        'class' => 'btn-info',
						'href' => HTTPS_SERVER . 'total/' . $extension . '&token=' . $this->session->data['token']
					);
					...
					$action[] = array(
                        ...
                        'class' => 'btn-danger',
						'href' => HTTPS_SERVER . 'extension/total/uninstall&token=' . $this->session->data['token'] . '&extension=' . $extension
					);
				}
