	...
	private $error = array(); 
  	...
  	public function insert() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->redirect(HTTPS_SERVER . 'setting/store/update&token=' . $this->session->data['token'] . '&store_id=' . $store_id);
    	}
  	...
  	public function update() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->redirect(HTTPS_SERVER . 'setting/store/update&token=' . $this->session->data['token'] . '&store_id=' . $this->request->get['store_id']);
		}
  	...
  	public function delete() {
		...
		if (isset($this->request->get['store_id']) && $this->validateDelete()) {
			...
			$this->redirect(HTTPS_SERVER . 'setting/setting&token=' . $this->session->data['token']);
		}
	...
	public function getForm() { 
		...
		if (isset($this->error['catalog_limit'])) {
  		...
  		$this->document->breadcrumbs = array();
   		...
   		$this->document->breadcrumbs[] = array(
       		'href'      => HTTPS_SERVER . 'setting/store&token=' . $this->session->data['token'],
		...
		$this->data['insert'] = HTTPS_SERVER . 'setting/store/insert&token=' . $this->session->data['token'];
		
		if (isset($this->request->get['store_id'])) {
			$this->data['delete'] = HTTPS_SERVER . 'setting/store/delete&token=' . $this->session->data['token'] . '&store_id=' . $this->request->get['store_id'];
		} else {
			$this->data['delete'] = '';
		}
		
		if (!isset($this->request->get['store_id'])) {
			$this->data['cancel'] = HTTPS_SERVER . 'setting/setting&token=' . $this->session->data['token'];
		} else {
			$this->data['cancel'] = HTTPS_SERVER . 'setting/store/update&token=' . $this->session->data['token'] . '&store_id=' . $this->request->get['store_id'];
		}
		
		if (!isset($this->request->get['store_id'])) {
			$this->data['action'] = HTTPS_SERVER . 'setting/store/insert&token=' . $this->session->data['token'];
		} else {
			$this->data['action'] = HTTPS_SERVER . 'setting/store/update&token=' . $this->session->data['token'] . '&store_id=' . $this->request->get['store_id'];
		}
		...
		$this->data['stores'][] = array(
			...
			'href'     => HTTPS_SERVER . 'setting/setting&token=' . $this->session->data['token']
		); 
		...
		foreach ($results as $result) {
			$this->data['stores'][] = array(
				...
				'name'     => $result['name'],
				'href'     => HTTPS_SERVER . 'setting/store/update&token=' . $this->session->data['token'] . '&store_id=' . $result['store_id']
			); 
		}
