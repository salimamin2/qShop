	...
	public function index() {     
        ...
        $this->document->breadcrumbs = array();
   		...
   		$this->document->breadcrumbs[] = array(
			...
			'href'      => HTTPS_SERVER . 'report/customer_reward&token=' . $this->session->data['token'] . $url,
      		'separator' => ' :: '
   		);		
		...
		$pagination->url = HTTPS_SERVER . 'report/customer_reward&token=' . $this->session->data['token'] . $url . '&page={page}';
