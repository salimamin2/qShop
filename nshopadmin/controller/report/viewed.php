...
class ControllerReportViewed extends Controller {
	public function index() {     
		...
		$this->document->breadcrumbs = array();
   		...
   		$this->document->breadcrumbs[] = array(
       		'href'      => HTTPS_SERVER . 'report/viewed&token=' . $this->session->data['token'] . $url,
...
//		$this->load->model('catalog/product');
		...
		$product_total = $oProd->getTotalProducts();
		...
		$this->data['reset'] = HTTPS_SERVER . 'report/viewed/reset&token=' . $this->session->data['token'] . $url;
		...
		$pagination->url = HTTPS_SERVER . 'report/viewed&token=' . $this->session->data['token'] . '&page={page}';
	...
	public function reset() {
		...
		$this->redirect(HTTPS_SERVER . 'report/viewed&token=' . $this->session->data['token'] . $url);
	}
}
?>