    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        ...
        <tr>
          ...
          <td><select name="left_brand_status">
              <?php if ($left_brand_status) { ?>
        ...
        <tr>
          ...
          <td><input type="text" name="left_brand_sort_order" value="<?php echo $left_brand_sort_order; ?>" size="1" /></td>
        </tr>
      </table>
    </form>
  </div>
