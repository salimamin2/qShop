    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        <tr>
          ...
          <td><input class="form-control" type="text" name="bestseller_limit" value="<?php echo $bestseller_limit; ?>" size="1" /></td>
        </tr>
        <tr>
          <td><?php echo $entry_position; ?></td>
          <td>
		  <div class="ui-select">
		  <select name="bestseller_position">
              <?php foreach ($positions as $position) { ?>
              <?php if ($bestseller_position == $position['position']) { ?>
