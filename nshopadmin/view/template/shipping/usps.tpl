<div class="box">
  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        <tr>
          <td> <?php echo $entry_user_id; ?><span class="required">*</span></td>
          <td><input class="form-control" type="text" name="usps_user_id" value="<?php echo $usps_user_id; ?>" />
        ...
        <tr>
          ...
          <td><input class="form-control" type="text" name="usps_password" value="<?php echo $usps_password; ?>" /></td>
        </tr>
        <tr>
          <td> <?php echo $entry_postcode; ?><span class="required">*</span></td>
          <td><input class="form-control" type="text" name="usps_postcode" value="<?php echo $usps_postcode; ?>" />
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="usps_size">
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="usps_container">
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="usps_machinable">
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="usps_weight_class">
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="usps_tax_class_id">
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="usps_geo_zone_id">
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="usps_status">
              <?php if ($usps_status) { ?>
