    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      ...
      <table class="form">
        ...
        <tr>
          ...
          <td><input class="form-control" type="text" name="free_total" value="<?php echo $free_total; ?>" /></td>
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="free_geo_zone_id">
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="free_customer_group[]" multiple="mulitple">

                  <?php foreach($customer_groups as $customer_group):?>

                  <?php if(in_array($customer_group['customer_group_id'],$free_customer_group)): ?>
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="free_status">
