    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        <tr>
          ...
          <td><input class="form-control"  type="text" name="ups_key" value="<?php echo $ups_key; ?>" />
            <?php if ($error_key) { ?>
            <span class="error"><?php echo $error_key; ?></span>
            <?php } ?></td>
        </tr>
        <tr>
          <td><?php echo $entry_username; ?><span class="required">*</span></td>
          <td><input class="form-control"  type="text" name="ups_username" value="<?php echo $ups_username; ?>" />
        ...
        <tr>
          ...
          <td><input class="form-control" type="text" name="ups_password" value="<?php echo $ups_password; ?>" />
