    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="royal_mail_weight_class">
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="royal_mail_tax_class_id">
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="royal_mail_geo_zone_id">
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="royal_mail_status">
