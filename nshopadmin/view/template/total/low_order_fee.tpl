    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      ...
      <table class="form">
        ...
        <tr>
          ...
          <td><input class="form-control" type="text" name="low_order_fee_total" value="<?php echo $low_order_fee_total; ?>" /></td>
        ...
        <tr>
          ...
          <td><input class="form-control" type="text" name="low_order_fee_fee" value="<?php echo $low_order_fee_fee; ?>" /></td>
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="low_order_fee_tax_class_id">
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="low_order_fee_status">
