      ...
      <div id="tab_store">
        ...
        <table class="form">
          ...
          <tr>
            ...
            <td><select name="template" onchange="$('#template').load('setting/store/template&token=<?php echo $token; ?>&template=' + encodeURIComponent(this.value));">
      ...
      <div id="tab_local">
        ...
        <table class="form">
          ...
          <tr>
            ...
            <td><select name="country_id" id="country" onchange="$('#zone').load('setting/store/zone&token=<?php echo $token; ?>&country_id=' + this.value + '&zone_id=<?php echo $zone_id; ?>');">
...
$('#template').load('setting/store/template&token=<?php echo $token; ?>&template=' + encodeURIComponent($('select[name=\'template\']').attr('value')));



$('#zone').load('setting/store/zone&token=<?php echo $token; ?>&country_id=<?php echo $country_id; ?>&zone_id=<?php echo $zone_id; ?>');
