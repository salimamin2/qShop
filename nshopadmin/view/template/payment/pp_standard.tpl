    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        <tr>
          ...
          <td><input class="form-control" type="text" name="pp_standard_email" value="<?php echo $pp_standard_email; ?>" />
            <?php if ($error_email) { ?>
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="pp_standard_transaction">
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="pp_standard_order_status_id">
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="pp_standard_geo_zone_id">
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="pp_standard_status">
