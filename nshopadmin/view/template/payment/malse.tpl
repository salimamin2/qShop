    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        <tr>
          ...
          <td><input type="text" name="malse_account" value="<?php echo $malse_account; ?>" />
        ...
        <tr>
          ...
          <td><input type="text" name="malse_domain" value="<?php echo $malse_domain; ?>" />
            <?php if ($error_domain) { ?>
        ...
        <tr>
          ...
          <td><select name="malse_order_status_id">
        ...
        <tr>
          ...
          <td><select name="malse_geo_zone_id">
        ...
        <tr>
          ...
          <td><input type="text" name="malse_sort_order" value="<?php echo $malse_sort_order; ?>" size="1" /></td>
        </tr>
      </table>
    </form>
  </div>
