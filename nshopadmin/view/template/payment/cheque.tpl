<div class="box">
  <div class="head well">
    <h3><i class="icon-credit-card"></i> <?php echo $heading_title; ?>
  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        <tr>
          <td> <?php echo $entry_payable; ?> <span class="required">*</span></td>
          <td><input class="form-control" type="text" name="cheque_payable" value="<?php echo $cheque_payable; ?>" />
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="cheque_geo_zone_id">
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="cheque_status">
