    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        <tr>
          ...
          <td><input type="text" name="payjunction_username" value="<?php echo $payjunction_username; ?>" />
        ...
        <tr>
          ...
          <td><input type="text" name="payjunction_password" value="<?php echo $payjunction_password; ?>" />
        ...
        <tr>
          ...
          <td><select name="payjunction_order_status_id">
        ...
        <tr>
          ...
          <td><select name="payjunction_geo_zone_id">
        ...
        <tr>
          ...
          <td><select name="payjunction_status">
        ...
        <tr>
          ...
          <td><input type="text" name="payjunction_sort_order" value="<?php echo $payjunction_sort_order; ?>" size="1" /></td>
        </tr>
      </table>
    </form>
  </div>
