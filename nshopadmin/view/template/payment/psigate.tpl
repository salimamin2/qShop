    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        <tr>
          ...
          <td><input type="text" name="psigate_merchant" value="<?php echo $psigate_merchant; ?>" />
            <br />
        ...
        <tr>
          ...
          <td><input type="text" name="psigate_password" value="<?php echo $psigate_password; ?>" />
        ...
        <tr>
          ...
          <td><input type="text" name="psigate_gateway" value="<?php echo $psigate_gateway; ?>" />
        ...
        <tr>
          ...
          <td><select name="psigate_order_status_id">
        ...
        <tr>
          ...
          <td><select name="psigate_geo_zone_id">
        ...
        <tr>
          ...
          <td><input type="text" name="psigate_sort_order" value="<?php echo $psigate_sort_order; ?>" size="1" /></td>
        </tr>
      </table>
    </form>
  </div>
