    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      ...
      <table class="form">
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="cod_order_status_id">
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="cod_geo_zone_id">
        ...
        <tr>
          ...
          <td><select name="cod_customer_group[]" multiple="mulitple">

                  <?php foreach($customer_groups as $customer_group):?>

                  <?php if(in_array($customer_group['customer_group_id'],$cod_customer_group)): ?>
        ...
        <tr>
          ...
          <td><div class="ui-select"><select name="cod_status">
