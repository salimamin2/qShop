...
<div class="box">
    ...
    <div class="head">
        ...
        <h4 style="background-image: url('view/image/order.png');"><?php echo $heading_title; ?></h4>
                            ...
                            <tbody id="product_<?php echo $order_product_row; ?>">
                                ...
                                <tr>
                                    ...
                                    <td class="left"><span class="remove" onclick="$('#product_<?php echo $order_product_row; ?>').remove();">&nbsp;</span><a href="<?php echo $order_product['href']; ?>"><?php echo $order_product['name']; ?> (<?php echo $order_product['model']; ?>)</a>
                                        ...
                                        <?php foreach ($order_product['detail'] as $option) { ?>
                                    ...
                                    <td class="right"><input type="hidden" name="product[<?php echo $order_product_row; ?>][quantity]" value="<?php echo $order_product['quantity']; ?>" size="4" /><?php echo $order_product['quantity']; ?></td>

                                    <td class="right"><input type="hidden" name="product[<?php echo $order_product_row; ?>][price]" value="<?php echo $order_product['raw_price']; ?>" class="text-right" /><?php echo $order_product['price']; ?></td>

                                    <td class="right"><input type="hidden" name="product[<?php echo $order_product_row; ?>][total]" value="<?php echo $order_product['raw_total']; ?>" class="text-right" /><?php echo $order_product['total']; ?></td>
                        ...
                        <tbody id="totals">
                            ...
                            <?php foreach ($totals as $totals) { ?>
                                ...
                                <tr>
                                    ...
                                    <td class="right"><input type="text" name="totals[<?php echo $totals['order_total_id']; ?>]" value="<?php echo $totals['text']; ?>" class="text-right" /></td>
                ...
                <div id="tab_shipping" class="vtabs_page">
                    ...
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td><select name="shipping_country_id" id="shipping_country" onchange="$('#shipping_zone').load('sale/order/zone&token=<?php echo $token; ?>&country_id=' + this.value + '&zone_id=<?php echo $shipping_zone_id; ?>&type=shipping_zone');">
                ...
                <div id="tab_payment" class="vtabs_page">
                    ...
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td><select name="payment_country_id" id="payment_country" onchange="$('#payment_zone').load('sale/order/zone&token=<?php echo $token; ?>&country_id=' + this.value + '&zone_id=<?php echo $payment_zone_id; ?>&type=payment_zone');">
                ...
                <div id="tab_history" class="vtabs_page">
                        ...
                        <table class="list">
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td class="left" width="33.3%"><b><?php echo $column_notify_manufacturer; ?></b></td>
                    ...
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td colspan="3"><select name="order_status_id">
                        ...
                        <tr>
                            ...
                            <td colspan="3"><input type="checkbox" name="append" value="1" checked="checked" /></td>
                        ...
                        <tr>
                            ...
                            <td colspan="3"><textarea name="comment" cols="40" rows="8" style="width: 99%"></textarea>
                                ...
                                <div style="margin-top: 10px; text-align: right;">
                                    ...
                                    <a onclick="history();" id="history_button" class="button"><span><?php echo $button_add_history; ?></span></a>
...
<script type="text/javascript"><!--
    ...
    function addProduct() {
        ...
        $('#product :selected').each(function() {
            ...
            html += '<a href="<?php echo HTTPS_SERVER . 'catalog/product/update&product_id='; ?>' + $(this).attr('value') + '&token=<?php echo $token; ?>">' + $(this).attr('text') + '</a>';
...
<script type="text/javascript"><!--
    ...
    function getProducts() {
        ...
        $.ajax({
            ...
            url: 'sale/order/category&token=<?php echo $token; ?>&category_id=' + $('#category').attr('value'),
...
<script type="text/javascript"><!--
    ...
    function history() {
        ...
        $.ajax({
            ...
            url: 'sale/order/history&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
            ...
            beforeSend: function() {
                ...
                $('#tab_history .form').before('<div class="alert alert-warning attention"><img src="view/image/loading_1.gif" alt="" /> <?php echo $text_wait; ?></div>');
            ...
            success: function(data) {
                ...
                if (data.error) {
                    ...
                    $('#tab_history .form').before('<div class="alert alert-warning warning">' + data.error + '</div>');
                ...
                if (data.success && $('input[name=\'append\']').attr('checked')) {
                    ...
                    html += '        <td class="left" width="33.3%"><b><?php echo $column_notify_manufacturer; ?></b></td>';
                    ...
                    html += '        <td class="left">' + data.notify_manufacturer + '</td>';
                    ...
                    $('#tab_history .form').before('<div class="alert alert-success success">' + data.success + '</div>');
...
<script type="text/javascript"><!--
    ...
    $('#shipping_zone').load('sale/order/zone&token=<?php echo $token; ?>&country_id=<?php echo $shipping_country_id; ?>&zone_id=<?php echo $shipping_zone_id; ?>&type=shipping_zone');

    $('#payment_zone').load('sale/order/zone&token=<?php echo $token; ?>&country_id=<?php echo $payment_country_id; ?>&zone_id=<?php echo $payment_zone_id; ?>&type=payment_zone');
