...
<div class="box">
  ...
  <div class="content">
    <div id="tabs" class="htabs">
        ...
        <a tab="#tab_data"><span><?php echo $tab_data; ?></span></a>
        <a tab="#tab_links"><span><?php echo $tab_links; ?></span></a>
         <a tab="#tab_detail"><span><?php echo __('Inventory'); ?></span></a>
        <a tab="#tab_option"><span><?php echo $tab_option; ?></span></a>
        <a tab="#tab_discount"><span><?php echo $tab_discount; ?></span></a>
        <a tab="#tab_special"><span><?php echo $tab_special; ?></span></a>
        <a tab="#tab_image"><span><?php echo $tab_image; ?></span></a>
    </div>
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      ...
      <div id="tab_data">
        <table class="form">
          ...
          <tr>
            <td><?php echo __('Product Type'); ?>
                <br /><span class="help"><?php echo __('Change will effective until all Inventory removed'); ?></span></td>
            <td>
                <select name='product_type_id' id='selPT' <?php echo (count($product_details)?'disabled':'')?>>
                <?php foreach ($product_types as $type):?>
                    <option value="<?php echo $type['product_type_id']?>" <?php echo $product_type_id==$type['product_type_id']?'selected':''?>><?php echo $type['title']?></option>
                <?php endforeach;?>
                </select>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td><input type="text" name="quantity" value="<?php echo $quantity; ?>" size="2" readonly /></td>
          </tr>
          <tr>
      ...
      <div id="tab_detail">
        <div style="width: 100%; display: inline-block; padding-bottom: 5px;">
          ...
          <thead>
            <tr>
              <td class="left" widht="20%"><?php echo __('column_code'); ?></td>
              <?php foreach($product_type_options as $options):?>
              <td class="left" widht="<?php echo count($product_type_options)>1?(40/count($product_type_options)):40?>%" ><?php echo __($options['name']); ?></td>
              <?php endforeach;?>
              <td class="left" widht="5%"><?php echo __('column_color_code'); ?></td>
              <td class="left" widht="5%"><?php echo __('column_quantity'); ?></td>
              <td class="left" widht="10%"><?php echo __('column_price'); ?></td>
              <td class="left" widht="10%"><?php echo __('column_priority'); ?></td>
          ...
          <tbody id="detail_row<?php echo $detail_row; ?>">
            <tr>
              <td class="left"><input type="text" name="product_detail[<?php echo $detail_row?>][code]" value="<?php echo $product_detail['code']?>" size="12" /></td>
              <?php foreach($product_type_options as $options):?>
              <td class="left">
                <select name="product_detail[<?php echo $detail_row?>][desc][<?php echo $options['product_type_option_id']?>]">
                <?php foreach($options['values'] as $value): ?>
                    <option value="<?php echo $value['product_type_option_value_id']?>" <?php echo $value['product_type_option_value_id']==$product_detail['desc'][$value['product_type_option_id']]?'selected':''?>><?php echo $value['name']?></option>
                <?php endforeach; ?>
                </select>
              </td>
              <?php endforeach; ?>
              <td class="left"><input type="text" name="product_detail[<?php echo $detail_row?>][color_code]" value="<?php echo $product_detail['color_code']?>" size="2" /></td>
              <td class="left"><input type="text" name="product_detail[<?php echo $detail_row?>][quantity]" value="<?php echo $product_detail['quantity']?>" size="10" /></td>
              <td class="left"><input type="text" name="product_detail[<?php echo $detail_row?>][price]" value="<?php echo $product_detail['price']?>" size="10" /></td>
              <td class="left"><input type="text" name="product_detail[<?php echo $detail_row?>][sort_order]" value="<?php echo $product_detail['sort_order']?>" size="5" /></td>
              <td class="left">
                  <select name="product_detail[<?php echo $detail_row?>][status]" >
                      <option value="1" <?php echo $product_detail['status']?'selected':''?>><?php echo __('Enable')?></option>
                      <option value="0" <?php echo $product_detail['status']?'':'selected'?>><?php echo __('Disable')?></option>
                   </select>

              </td>
              <td class="left"><a onclick="$('#detail_row<?php echo $detail_row; ?>').remove();" class="button"><span><?php echo $button_remove; ?></span></a></td>
            </tr>
          </tbody>
          <?php $detail_row++; ?>
          <?php  endforeach; ?>
          <tfoot>
            <tr>
              <td colspan="7"></td>
              <td class="left"><a onclick="addProductDetail();" class="button"><span><?php echo __('Add'); ?></span></a></td>
            </tr>
          </tfoot>
        </table>
        </div>
...
CKEDITOR.replace('description<?php echo $language['language_id']; ?>', {
	filebrowserBrowseUrl: 'common/filemanager&token=<?php echo $token; ?>',
	filebrowserImageBrowseUrl: 'common/filemanager&token=<?php echo $token; ?>',
	filebrowserFlashBrowseUrl: 'common/filemanager&token=<?php echo $token; ?>',
	filebrowserUploadUrl: 'common/filemanager&token=<?php echo $token; ?>',
	filebrowserImageUploadUrl: 'common/filemanager&token=<?php echo $token; ?>',
	filebrowserFlashUploadUrl: 'common/filemanager&token=<?php echo $token; ?>'
});
<?php } ?>
//--></script>
<script type="text/javascript"><!--
...
function getProducts() {
	...
	$.ajax({
		url: 'catalog/product/category&token=<?php echo $token; ?>&category_id=' + $('#category').attr('value'),
		dataType: 'json',
...
function getRelated() {
	...
	$.ajax({
		url: 'catalog/product/related&token=<?php echo $token; ?>',
		type: 'POST',
		dataType: 'json',
...
var option_value_row = <?php echo (int)$option_value_row; ?>;
...
function image_upload(field, preview) {
	...
	$('#content').prepend('<div id="dialog" style="padding: 3px 0px 0px 0px;"><iframe src="common/filemanager&token=<?php echo $token; ?>&field=' + encodeURIComponent(field) + '" style="padding:0; margin: 0; display: block; width: 100%; height: 100%;" frameborder="no" scrolling="auto"></iframe></div>');
	...
	$('#dialog').dialog({
		...
		close: function (event, ui) {
			if ($('#' + field).attr('value')) {
				$.ajax({
					url: 'common/filemanager/image&token=<?php echo $token; ?>',
					type: 'POST',
...
//--></script>
<script type="text/javascript"><!--
var detail_row = <?php echo $detail_row; ?>;
function addProductDetail() {
    ...
    <?php endforeach; ?>
    html += '</select></td>';
    html += '<td class="left"><input type="text" name="product_detail[' + detail_row + '][color_code]" value="" size="10" /></td>';
    html += '<td class="left"><input type="text" name="product_detail[' + detail_row + '][quantity]" value="" size="2" /></td>';
    html += '<td class="left"><input type="text" name="product_detail[' + detail_row + '][price]" value="" /></td>';
    ...
    html += '</select> ';
    html += '<td><a onclick="$(\'#detail_row' + detail_row + '\').remove();" class="button"><span><?php echo $button_remove; ?></span></a></td>';
    html += '</tr>';
    html += '</tbody>';

    $('#detail tfoot').before(html);
    detail_row++;
}
//--></script>
