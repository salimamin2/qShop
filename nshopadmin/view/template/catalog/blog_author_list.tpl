<form action="" method="post" enctype="multipart/form-data" id="form">
    <div class="box">
        ...
        <?php } ?>
        <div class="content">
            <table class="table table-hover" data-rel="ajax-grid" data-grid-url="<?php echo $blogauthorList ?>">
                <thead>
                    <tr>
                        <th width="1%" style="text-align: center;"><input type="checkbox" onClick="$('input[name*=\'selected\']').attr('checked', this.checked);" /></th>
                        <th class="left"><span class="line"></span><?php echo __('column_id'); ?></th>
                        <th class="left"><span class="line"></span><?php echo __('column_fname'); ?></th>
                        <th class="right"><span class="line"></span><?php echo __('column_lname'); ?></th>
