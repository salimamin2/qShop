        ...
        <div class="head well">
            <h3>
                ...
                <div class="pull-right">
                    ...
                    <button type="button" onClick="$('#form').attr('action', '<?php echo $delete; ?>').submit();"  class="btn-flat btn-danger"><span><?php echo $button_delete; ?></span></button>
                </div>
            </h3>
        </div>
                ...
                <table class="table table-hover" data-rel="ajax-grid" data-grid-url="<?php echo $sblogCateList ?>">
                    <thead>
                        <tr>
                            ...
                            <th class="left"><span class="line"></span><?php echo __('column_status'); ?></th>
