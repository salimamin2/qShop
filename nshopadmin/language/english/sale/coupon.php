...
$_['text_deleted']           = 'Success: You have deleted coupons!';
...
$_['error_date_start']    = "Start Date cannot be empty";
$_['error_date_end']      = "End Date should be greater than start date";
$_['error_warning']       = "Please check for field errors!"
?>
