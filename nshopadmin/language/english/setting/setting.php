...
$_['entry_alert_manager_mail']= 'Alert Mail To Account Manager:<br /><span class="help">Send a email to the customer Account Manager when a new order is created.</span>';
...
$_['entry_cross_sell_limit'] 	  = 'Show Items of Cross sell:<br /><span class="help">Determines how many cross sell items are shown on cart</span>';
$_['entry_sales_manager']   = 'Sales Manager email<br /><span class="help">Send approval message of Customer New Record to this email.</span>';
...
$_['entry_token_ignore']      = 'Ignore Tokens on these pages:<br /><span class="help">This version of Q-Cart has a token system for admin security. Modules that have not been updated for token support yet can be checked to ignore the token check and allow them to work as normal.</span>';
$_['entry_import_order_status']   = 'Latest Sale Order Status:<br /><span class="help">Set the order status the customers order must reach before they are allowed to appear in Latest Sale webservice.  </span>';
$_['button_add_store']        = 'Create A New Store:';
$_['entry_category_color']        = 'Color Category:';
$_['entry_category_fabric']        = 'Custom Shirt Category:<div class="help">Set the parent category to show in customize shirt.</div>';
$_['entry_category_left_menu']        = 'Categories in Left Menu:';
$_['entry_category_home']        = 'Categories on Home:';
$_['entry_category_brand']        = 'Brands Categories:';
$_['entry_facebook_page']        = 'Facebook Page:';
$_['entry_google_map']        = 'Google Map Code:';
$_['entry_cart_weight']        = 'Cart Weight:';
$_['entry_cutoff_time']        = 'Cutoff Time:';
$_['entry_reward_status']   = 'Reward Point Order Status:<br /><span class="help">Select order status to add Reward point in customer autometically</span>';
$_['entry_reward']          = 'Allow Reward Points:<br /><span class="help">Select Yes to allow shopping using Reward points</span>';
...
$_['error_cutoff']       	  = 'Cutoff Time required!';
