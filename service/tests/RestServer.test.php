<?
    ...
    include ("../../library/service/RestServer.php");
    include ("../../library/service/RestResponse.php");
    include ("../../library/service/RestRequest.php");
    include ("../../library/service/RestAction.php");
    include ("../../library/service/RestView.php");
    include ("../../library/service/RestController.php");
