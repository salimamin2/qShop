...
class ModelAccountDownload extends Model {
	...
	public function getTotalDownloads() {
        ...
        public function listFolderDocuments()
        {
            $files = array();
            // Define the full path to your <span class="posthilit">folder</span> <span class="posthilit">from</span> root
             $path = DIR_ROOT."/upload/documents";
        ...
        public function listTotalFolderDocuments()
        {
            $files = array();
            // Define the full path to your <span class="posthilit">folder</span> <span class="posthilit">from</span> root
             $path = DIR_ROOT."/upload/documents";
