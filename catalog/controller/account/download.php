...
class ControllerAccountDownload extends Controller {
    ...
    public function index() {
        ...
        if ($download_total) {
            ...
            foreach ($results as $result) {
                if (file_exists(DIR_DOWNLOAD . $result['filename'])) {
                    ...
                    $this->data['downloads'][] = array(
                        ...
                        'href' => HTTPS_SERVER . 'account/download/download&order_download_id=' . $result['order_download_id']
                    );
                }
            }
            ...
            $pagination->url = HTTP_SERVER . 'account/download&page=%s';
    ...
    public function download() {
        ...
        if ($download_info) {
            ...
            $this->redirect(HTTPS_SERVER . 'account/download');
        }
    }
