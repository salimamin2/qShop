...
class ControllerPaymentPaypoint extends Controller {
	protected function index() {
		...
		$this->data['callback'] = HTTPS_SERVER . 'payment/paypoint/callback';
	...
	public function callback() {
		...
		$this->data['text_failure_wait'] = sprintf($this->language->get('text_failure_wait'), HTTPS_SERVER . 'checkout/cart');
