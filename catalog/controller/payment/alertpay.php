...
class ControllerPaymentAlertPay extends Controller {
	protected function index() {
		...
		$this->data['ap_returnurl'] = HTTPS_SERVER . 'checkout/success';
		
		if ($this->request->get['act'] != 'checkout/guest_step_3') {
			$this->data['ap_cancelurl'] = HTTPS_SERVER . 'checkout/payment';
		} else {
			$this->data['ap_cancelurl'] = HTTPS_SERVER . 'checkout/guest_step_2';
		}
