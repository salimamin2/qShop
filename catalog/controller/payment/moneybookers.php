...
class ControllerPaymentMoneybookers extends Controller {
	protected function index() {
        ...
        $this->data['return_url'] = HTTPS_SERVER . 'checkout/success';
		
		if ($this->request->get['act'] != 'checkout/guest_step_3') {
			$this->data['cancel_url'] = HTTPS_SERVER . 'checkout/payment';
		} else {
			$this->data['cancel_url'] = HTTPS_SERVER . 'checkout/guest_step_2';
		}
		
		$this->data['status_url'] = HTTPS_SERVER . 'payment/moneybookers/callback';
