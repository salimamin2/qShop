...
class ControllerPaymentNochex extends Controller {
	protected function index() {
	   ...
	   if ($this->config->get('nochex_email') != $this->config->get('nochex_merchant')){ // This MUST be changed on your Nochex account!!!!
        ...
        $this->data['success_url']        = HTTPS_SERVER . 'checkout/success';
        $this->data['cancel_url']         = HTTPS_SERVER . 'checkout/payment';
        $this->data['declined_url']       = HTTPS_SERVER . 'checkout/failure';
        //$this->data['callback_url']       = HTTPS_SERVER . 'checkout/payment'; // ???Not sure about this
