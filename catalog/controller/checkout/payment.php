...
class ControllerCheckoutPayment extends Controller {
    ...
    public function index() {
        ...
        if (!$this->session->data['payment_address_id']) {
            $this->redirect(HTTPS_SERVER . 'checkout/address/payment');
        }
        $this->load->model('account/address');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->redirect(HTTPS_SERVER . 'checkout/confirm');
        }
        ...
        $this->document->breadcrumbs[] = array(
            'href' => HTTP_SERVER . 'checkout/shipping',
            'text' => $this->language->get('text_shipping'),
            'separator' => $this->language->get('text_separator')
        );
        $this->document->breadcrumbs[] = array(
            'href' => HTTP_SERVER . 'checkout/payment',
        ...
        $this->data['action'] = HTTPS_SERVER . 'checkout/payment';
        ...
        $this->data['change_address'] = HTTPS_SERVER . 'checkout/address/payment';
        ...
        if ($this->config->get('config_checkout_id')) {
            ...
            if ($information_info) {
                $this->data['text_agree'] = sprintf($this->language->get('text_agree'), HTTPS_SERVER . 'information/information/loadInfo&checkout=1&information_id=' . $this->config->get('config_checkout_id'), $information_info['title']);
            } else {
        ...
        if ($this->cart->hasShipping()) {
            ...
            $this->data['back'] = HTTPS_SERVER . 'checkout/cart';
        }
