...
<html lang="en">
    <html xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml" >
        <head>
            ...
            <script>
                var coupon_url = '<?php echo $coupon_code; ?>';
            </script>
            ...
            <link rel="stylesheet" type="text/css" href="catalog/view/theme/modern/stylesheet/styles.css" />
        ...
        <body id="notBody">
            ...
            <div id="ju_Con">
                ...
                <div id="share_options">
                    <?php if ($coupon_fb_link): ?>
                        <div id="share_facebook">
                            <fb:like href="https://www.facebook.com/<?php echo $coupon_fb_link ?>" send="false" layout="box_count" show_faces="false" ref="<?php echo $coupon_fb_link ?>"></fb:like>
                        </div>
                    <?php endif; ?>
                    <?php if ($coupon_gp_link): ?>
                        <div id="share_google">
                            <div class="g-plusone" data-size="tall" data-callback="plusone_vote" data-href="<?php echo $coupon_gp_link ?>" data-recommendations="false"></div>
                        </div>
                    <?php endif; ?>
                    <?php if ($coupon_tt_link): ?>
                        <div id="share_twitter"> <a href="http://twitter.com/share" class="twitter-share-button"
                                                    ...
                                                    data-via="<?php echo $coupon_tt_link ?>"
                                                    data-text="<?php echo $this->config->get('config_title') ?>"

                                                    data-count="vertical">Tweet</a> </div>

                        <div id="share_twitter_follow"> <a href="https://twitter.com/https://twitter.com/<?php echo $coupon_tt_link ?>" class="twitter-follow-button" data-show-count="false" data-count="vertical" data-show-screen-name="false" data-dnt="true">Follow</a> </div>
                    <?php endif; ?>
                </div>
