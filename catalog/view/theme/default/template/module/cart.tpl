<div class="cart" style="">
	<?php if ($products) : ?>
    	   ...
    	   <!--  <h4 class="block-subtitle"><?php // echo __('text_recent_item') ?></h4> -->
    	   	<div class="overlay-cart">
						...
						<li class="item last odd">
				    		...
				    		<div class="hover-cart">
	    						...
	    						<form id='myform' method='POST' action='#'>
                                    ...
                                    <input type="hidden" id="stock_<?php echo $aProduct['id']; ?>" value="<?php echo $aProduct['stock']; ?>">
								</form>
	    					</div>
						</li>
	    		...
	    		<div class="main-sum">
                    ...
                    <?php /*<td class="a-right"><?php echo $total_qty; ?></td>*/ ?>
				</div>
    		</div>
    	...
    	<div class="continue-shop">
			<button type="button" title="<?php echo $text_checkout; ?>" class="button btn-checkout btn-inline">
                <span><span><?php echo $text_checkout; ?></span></span>
            </button>
		</div>
	<?php else : ?>
        <div class="block-content-inner">
            <div class="cart-img-empty">
                <img src="catalog/view/theme/default/image/img/emotion-cart.png" alt="Cart">
            </div>
