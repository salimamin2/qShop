                ...
                <div class="col-md-12">
                    <div class="row">
                        <?php foreach ($totals as $total) { ?>
                            <div class="col-sm-9 col-md-9 text-right <?php echo $total['key'] ?> sum_price"><?php echo $total['title']; ?></div>
                            <div class="col-sm-3 col-md-3 text-right"><?php echo $total['text']; ?></div>
