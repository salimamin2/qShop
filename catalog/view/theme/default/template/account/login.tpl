<div id="Content" class="col-main grid-full in-col1 content-main">
    ...
    <form action="<?php echo str_replace('&', '&amp;', $action); ?>" method="post" enctype="multipart/form-data" id="login_create">
    ...
    <div class="registered-users col-md-6">
        <div class="content">
            ...
            <ul class="form-list">
                <li>
                    ...
                    <div class="input-box">
                        <input placeholder="*<?php echo __('Email Address'); ?>" type="text" name="email" id="email" class="input-text required-entry validate-email" />
                    </div>
                </li>
                <li>
        ...
        <div class="buttons-set">
            ...
            <button type="submit" class="btn btn-subs btn-acount-create validation-passed" style="margin:0px 10px;"><span><span><?php echo $button_login; ?></span></span></button>
        </div>
    </div>
    </form>
    </div>
