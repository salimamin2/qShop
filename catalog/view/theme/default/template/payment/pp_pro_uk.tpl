...
<div class="buttons">
    <a onclick="location = '<?php echo str_replace('&', '&amp;', $back); ?>'" class="button left"><span><?php echo $button_back; ?></span></a>
    <a onclick="confirmSubmit();" id="paypal_button" class="button"><span><?php echo $button_confirm; ?></span></a>
</div>
<script type="text/javascript"><!--
function confirmSubmit() {
	$.ajax({
		type: 'POST',
		url: 'payment/pp_pro_uk/send',
		data: $('#paypal :input'),
		dataType: 'json',		
		beforeSend: function() {
