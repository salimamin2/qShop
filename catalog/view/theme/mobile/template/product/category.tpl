<div id="Content" class="container">
	...
	<div class="col-main grid12-9 grid-col2-main in-col2 category-panel">
		...
		<div class="large- columns no-padding">
			<div class="sorter">
				<div class="col-sm-8 large-8 columns" class="" style="">
		            ...
		            <div class="text-center">
		            	<button id="select_filters" class="select-style" title="<?php echo $text_tooltip; ?>"><?php echo (count($post_filters) > 0 ? 'Add More' : 'Filter by'); ?></button>
		            </div>
				</div>

				<div class="col-sm-4 large-4 filter-sort-main columns no-pading">
