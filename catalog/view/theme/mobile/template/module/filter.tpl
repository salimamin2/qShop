                                        ...
                                        <ol>
                                            <?php foreach ($filter['values'] as $k => $v): ?>
                                                <li>
                                                        ...
                                                        <div id="<?php echo $k; ?>">
                                                            <ul>
                                                                <?php foreach($v['childs'] as $id => $child): ?>
                                                                    <?php $bChecked = isset($org_post_filters[$filter['field']]) && in_array($id,$org_post_filters[$filter['field']]) ? true : false; ?>
                                                                    <li class="skin-minimal">
                                                                        <button type="button" value="<?php echo 'filter[' . $filter['field'] . '][]=' . $id; ?>" class="filter-check <?php echo ($bChecked ? 'selected' : ''); ?>"><span>
                                                    ...
                                                    <?php else: ?>
                                                        <?php $bChecked = isset($org_post_filters[$filter['field']]) && in_array($k,$org_post_filters[$filter['field']]) ? true : false; ?>
                                                        <div class="skin-minimal">
                                                            <button type="button" value="<?php echo 'filter[' . $filter['field'] . '][]=' . $k; ?>" class="filter-check <?php echo ($bChecked ? 'selected' : ''); ?>"><span>
