<div id="Content" class="my-account container">
    ...
    <div class="col-md-12">
        ...
        <form action="<?php echo str_replace('&', '&amp;', $action); ?>" method="post" enctype="multipart/form-data" id="forgotten" class="width-50">
            <div class="fieldset">
                ...
                <ul class="form-list">
                    <li>
                        ...
                        <div class="input-box">
                            <input type="email" name="email" id="email" value="<?php echo $email; ?>" class="input-text required-entry validate-email" size="48" />
                        </div>
                    </li>
                </ul>
            </div>
