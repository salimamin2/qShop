				...
				<div class="order-items order-details">
						...
						<?php
							...
							?>
								<tr class="<?php echo $class; ?>">
									...
									<td class="last text-center"><span class="price"><?php echo $total['text']; ?></span></td>
								</tr>
							<?php } ?>
						</tfoot>
					</table>
					...
					<?php if (!$module): ?>
						<div class="buttons-set row">
							<div class="col-sm-6">
								<p class="go-back back-link"><a href="<?php echo str_replace('&', '&amp;', $continue); ?>"><small>&laquo; </small><?php echo __("Back to Order History"); ?></a></p>
							</div>
