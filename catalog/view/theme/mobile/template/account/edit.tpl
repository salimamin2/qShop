<form action="<?php echo str_replace('&', '&amp;', $action); ?>" method="post" enctype="multipart/form-data" id="edit">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="input-box">
                    <input class="input-text required-entry validate-email" type="email" name="email" id="email" value="<?php echo $email; ?>" placeholder="<?php echo $entry_email; ?>" />
                </div>
            </div>
        </div>
        <div class="row">
            <div class="skin-minimal">
                <div class="col-md-6">
                    ...
                    <div class="col-xs-10 col-md-11 no-padding text-left">
