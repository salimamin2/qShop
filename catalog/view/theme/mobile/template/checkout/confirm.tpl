                    ...
                    <div class="users col-sm-6">
                        <form action="javascript:void(0)" method="post" enctype="multipart/form-data" id="login_form">
                            ...
                            <div class="buttons-set row">
                                ...
                                <div class="col-sm-6">
                                    <button style="display: none;" class="validation-passed btn btn-cntinue btn-account right" id="register">
                                        <span>
                            ...
                            <div id="forgotten" style="display:none;">
                                <div class="fieldset">
                                    ...
                                    <div class="input-box">
                                        <input type="email" name="email" id="email_forgotten" value="<?php echo $email; ?>" class="input-text required-entry validate-email" size="48" />
                                    </div>
                                </div>
                ...
                <form action="<?php echo str_replace('&', '&amp;', $action); ?>" method="post" enctype="multipart/form-data" id="checkout_address">
                    ...
                    <div class="section active" id="address_information">
                        <div class="step a-item" id="shipping_option">
                                                ...
                                                <?php foreach($shipping_addresses as $i => $address): ?>
                                                    <li class="control col-sm-12 no-padding address-pane">
                                                        <div class="skin-minimal">
                                                            ...
                                                            <label for="shipping_addr_<?php echo $address['address_id']; ?>" class="left"><?php echo $address['address']; ?></label>
                                                            </div>
                                                        </div>
                                                    </li>
                                                <?php endforeach; ?>
                            ...
                            <div class="clearfix"></div>
                            <div id="shipping_form" class="row" style="display: <?php echo ($shipping_addresses ? 'none' : 'block'); ?>" >
                                <div class="col-sm-12">
                                    <div class="row1">
                                        <div class="col-sm-6">
                                        ...
                                        <?php if(!$this->customer->isLogged()) : ?>
                                            <div class="col-sm-6">
                                                ...
                                                <div class="input-box">
                                                    <input type="email" name="shipping[<?php echo $form_code ?>][email]" id="shipping_email" class="input-text validate-email required-entry" value="<?php echo $shipping_address['email']; ?>" placeholder="*<?php echo __('Shipping Email'); ?>" />
                                                </div>
                                            </div>
                                        <?php endif; ?>
                        ...
                        <div class="step a-item payment_option row1">

                            <div class="control check-shipping-payment col-sm-12">
                                <div class="col-xs-2 col-sm-1 no-padding skin-minimal">
                            ...
                            <div id="payment_address_select" style="display: none;">
                                ...
                                <div class="grid12-8">
                                    <ul class="form-list">
                                        ...
                                        <li id="payment_row_<?php echo $address['address_id']; ?>" class="table payment_row control">
                                            <input type="radio"
                                                   name="payment[address_id]"
                                                   value="<?php echo $address['address_id']; ?>"
                                                   id="payment_address_<?php echo $address['address_id']; ?>"
                                                   class="payment_address_list address radio left" />
                                            <address class="left"><?php echo $address['address']; ?></address>
                                        </li>
                                        <?php endforeach; ?>
                                    </ul>
                                </div>
                                ...
                                <div class="col-sm-10">       
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="input-box">
                                                <input type="text" name="payment[<?php echo $form_code ?>][company]" id="payment_company" value="<?php echo $payment_address['company']; ?>" class="input-text validate-phoneStrict required-entry" placeholder="*<?php echo 'Billing Phone:' ?>" />
                                            </div>
                                        </div>
                                        ...
                                        <div id="product-tabs">
                                            ...
                                            <div class="Tabs clearer payment-select row">
                                                ...
                                                <?php foreach ($payment_methods as $payment_method): ?>
                                                    <div class="col-sm-6">
                                                        <div class="list-payment col-sm-12 control skin-minimal no-padding">
                                                            ...
                                                            <div class="col-xs-10">
                                                                <label class="payment-text" for="payment_<?php echo $payment_method['id']; ?>"><?php echo $payment_method['title']; ?></label>
                                                            </div>
                                                            <div class="clearfix"></div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="tabs-panels">
                                                <?php foreach ($payment_methods as $i => $payment_method): ?>
                                                    <div class="payment-panels" id="<?php echo $payment_method['id']; ?>">
                                                       <!--  <div class="col-sm-12">
                                                            <p class="acctab sub-heading-acount" id="acctab-<?php echo $payment_method['id']; ?>"><?php echo $payment_method['title']; ?></p>
                                                            <div class="line"></div>
                                                        </div> -->
