...
<html>
    ...
    <body>
        <table style="font-family: Verdana,sans-serif; font-size: 12px; color: #000000; width: 600px;">
            <tr>
                <td align="middle" style="background:#333333;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>">
                <img src="<?php echo $store_logo; ?>" alt="<?php echo $store_name; ?>" style="border: none;" ></a></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                <td align="middle" style="background-color: #030303; color:#FFFFFF; text-transform: uppercase; padding: 0.5em 1em;"><?php echo $text_order_detail; ?></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <?php echo $text_order_id; ?><?php echo $order_id; ?></span><br />
            ...
            <tr>
                <td><table style="width: 100%;">
                        <tr style="background-color: #030303; text-transform: uppercase;">
            ...
            <tr>
               <td align="left"><table cellpadding="3" cellspacing="3" style="width: 100%;">
                        <tr style="background-color: #030303; text-transform: uppercase;">
                            <th align="left" style="width: 20%; font-weight: normal; padding: 0.3em; color: #FFFFFF;"><?php echo __('Product Image'); ?></th>
                            <th align="left" style="color: #FFFFFF;font-weight: normal; "><?php echo __('Product Name'); ?></th>
                            <th align="right" style="width: 10%; font-weight: normal; padding: 0.3em; color: #FFFFFF;"><?php echo $column_price; ?></th>
                            <th align="center" style="width: 10%; font-weight: normal; padding: 0.3em; color: #FFFFFF;"><?php echo $column_quantity; ?></th>
                            <th align="right" style="width: 15%; font-weight: normal; padding: 0.3em; color: #FFFFFF;"><?php echo $column_total; ?></th>
                        </tr>
        ...
        <?php if ($comment) { ?>
            <tr>
            <td align="middle" style="background-color: #030303; color: #FFFFFF; font-size: 12px; padding: 0.5em 1em; text-transform: uppercase;"><?php echo $text_comment; ?></td>
            </tr>
            <tr>
            <td>&nbsp;</td>
            </tr>
        ...
        <?php if ($customer_id) { ?>
            <tr>
            <td align="middle" style="background-color: #030303; color: #FFFFFF; font-size: 12px; padding: 0.5em 1em; "><?php echo $text_invoice; ?></td>
            </tr>
            <tr>
            <td>&nbsp;</td>
            </tr>
