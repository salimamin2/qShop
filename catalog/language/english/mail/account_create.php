...
$_['text_admin_subject'] = 'New customer account';
$_['text_admin_approval']  = "Hello admin \n\nThis email is to notify that the Lead account is created and has to be qualified and activated.\n Account Detail: \n";
$_['text_account_success']         = 'Account is created successfully';
?>